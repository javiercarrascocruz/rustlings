...
fn count_iterator(map: &HashMap<String, Progress>, value: Progress) -> usize {
    ...
    // values() -> iterator over the values of HashMap. The returned value is &V.
    // filter() -> dereference and compare to count()
...
fn count_collection_iterator(collection: &[HashMap<String, Progress>], value: Progress) -> usize {
    ...
    //     { "variables2": Complete, ... }, ... ]
    // use count_iterator() in a map() and sum the results
